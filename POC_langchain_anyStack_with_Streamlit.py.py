...
# Streamlit UI
st.title("Nexus DevOps Agent")

user_input = st.text_input("Enter your instruction", value="Generate a pipeline for Java with Maven and commit to GitHub repo https://github.com/<your-username>/<your-repo> on main branch")
    ...
    if user_input:
        with st.spinner("Running agent..."):
            try:
                ...
                st.success("Pipeline committed to GitHub.")
